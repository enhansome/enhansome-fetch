...
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,690 | 🐛 93 | 🌐 C | 📅 2026-09-19 - Like neofetch, but much faster because written in C. `C`
...
* [hyfetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,105 | 🐛 13 | 🌐 Shell | 📅 2026-08-09 - Neofetch with LGBTQ+ pride flags. `Python`
* [neowofetch](https://github.com/hykilpikonna/hyfetch#running-updated-original-neofetch) ⭐ 2,105 | 🐛 13 | 🌐 Shell | 📅 2026-08-09 - An updated, actively maintained fork of neofetch inside the HyFetch repo. `Shell`
...
* [animfetch](https://github.com/Andrew-Velox/animfetch) ⭐ 156 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - Animated system fetch that stays pinned above your shell while you work. `Rust`
...
* [albafetch](https://github.com/alba4k/albafetch) ⭐ 74 | 🐛 1 | 🌐 C | 📅 2026-09-19 - Faster neofetch alternative, written in C. Still improving :). `C`
...
* [SmartFetch](https://github.com/Yassine-Jemi01/SmartFetch) ⭐ 23 | 🐛 0 | 🌐 C | 📅 2026-09-18 - A fast and lightweight system information fetch tool written in C. `C`
...
* [Haxefetch](https://github.com/ACoolioDude/Haxefetch) ⭐ 7 | 🐛 1 | 🌐 Haxe | 📅 2026-09-18 - Haxefetch is fetch program inspired by neofetch, fastfetch, pfetch, nerdfetch, hyfetch and so on. `Haxe`
...
* [gpufetch](https://github.com/Dr-Noob/gpufetch) ⭐ 198 | 🐛 35 | 🌐 C++ | 📅 2026-09-12 - Simple yet fancy GPU architecture fetching tool. `C++`
...
* [songfetch](https://github.com/ekrlstd/songfetch) ⭐ 111 | 🐛 8 | 🌐 Python | 📅 2025-11-16 - A Linux CLI tool, very similar to neofetch, that displays current song information in the terminal. `Python`
