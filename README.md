...
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,194 | 🐛 69 | 🌐 C | 📅 2026-08-13 - Like neofetch, but much faster because written in C. `C`
...
* [hyfetch](https://github.com/hykilpikonna/hyfetch) ⭐ 2,085 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - Neofetch with LGBTQ+ pride flags. `Python`
* [neowofetch](https://github.com/hykilpikonna/hyfetch#running-updated-original-neofetch) ⭐ 2,085 | 🐛 9 | 🌐 Shell | 📅 2026-08-09 - An updated, actively maintained fork of neofetch inside the HyFetch repo. `Shell`
...
* [pfetch-rs](https://github.com/Gobidev/pfetch-rs) ⭐ 363 | 🐛 13 | 🌐 Rust | 📅 2026-05-25 - A pretty system information tool written in Rust. `Rust`
...
* [afetch](https://github.com/13-CF/afetch) ⭐ 240 | 🐛 30 | 🌐 C | 📅 2024-05-02 - Simple system info written in C. `C`
* [bunnyfetch](https://github.com/Rosettea/bunnyfetch) ⭐ 191 | 🐛 1 | 🌐 Go | 📅 2025-01-14 - Tiny system info fetch utility. `Go`
* [sysfex](https://github.com/mehedirm6244/sysfex) ⭐ 160 | 🐛 1 | 🌐 C++ | 📅 2024-12-28 - Another system information tool written in C++. `C++`
* [winfetch](https://github.com/M4cs/winfetch) ⭐ 151 | 🐛 7 | 🌐 Go | 📅 2021-10-28 - Neofetch/Screenfetch Alternative Written in Golang. `Go`
...
* [albafetch](https://github.com/alba4k/albafetch) ⭐ 75 | 🐛 0 | 🌐 C | 📅 2026-08-11 - Faster neofetch alternative, written in C. Still improving :). `C`
...
* [yafetch](https://github.com/yrwq/yafetch) ⭐ 35 | 🐛 0 | 🌐 Rust | 📅 2026-01-21 - Yet another fetch. `Rust`
* [mfetch](https://github.com/rachelambda/mfetch) ⭐ 34 | 🐛 0 | 🌐 Shell | 📅 2020-12-03 - Minimalist fetch. `Shell`
...
* [unifetch](https://github.com/nmimusic/unifetch) ⭐ 28 | 🐛 1 | 🌐 Shell | 📅 2025-12-10 - An unofficial inheritor of Neofetch. `Shell`
...
* [info.sh](https://github.com/bc1bb/info.sh) ⭐ 18 | 🐛 0 | 🌐 Shell | 📅 2022-08-23 - Info.sh is a little script that works like screenfetch or neofetch, it show infos. `Shell`
...
* [zfetch](https://github.com/emilydaemon/zfetch) ⚠️ Archived - This is a simple, fast, but pretty fetch script. `Shell`
...
* [winfetch](https://github.com/lptstr/winfetch) ⭐ 1,787 | 🐛 26 | 🌐 PowerShell | 📅 2024-05-09 - A command-line system information utility written in PowerShell. Like Neofetch, but for Windows. `PowerShell`
* [horizonfetch](https://github.com/horizonwiki/horizonfetch) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-02-12 - Forged in Rust, shaped by your style. `Rust`

### GNU/Linux Only

* [nitch](https://github.com/ssleert/nitch) ⭐ 650 | 🐛 32 | 🌐 Nim | 📅 2024-06-22 - A incredibly fast system fetch written in nim. `Nim`
* [Catnap](https://github.com/iinsertNameHere/catnap) ⭐ 290 | 🐛 2 | 🌐 Nim | 📅 2026-07-01 - A playful, simple system-information concatenation tool. `Nim`
* [pokemon-icat](https://github.com/aflaag/pokemon-icat) ⭐ 149 | 🐛 3 | 🌐 Python | 📅 2025-08-03 - Shows any Pokémon sprite in your terminal. `Python`
...
* [vfetch](https://github.com/Lorago/vfetch) ⭐ 64 | 🐛 1 | 🌐 Python | 📅 2021-05-18 - A simple fetch tool for Linux written in Python. `Python`
* [androfetch](https://github.com/laraib07/androfetch) ⭐ 62 | 🐛 0 | 🌐 Shell | 📅 2021-08-01 - A pretty system information tool written in bash for termux on android. `Shell`
...
* [tinyfetch](https://github.com/beucismis/tinyfetch) ⚠️ Archived - Python and system information command-line fetch tool. `Python`
* [pokefetch](https://github.com/Discomanfulanito/pokefetch) ⭐ 26 | 🐛 0 | 🌐 Shell | 📅 2026-01-23 - This script fetches a random Pokémon sprite and displays it alongside system info using a fetcher (currently only works with fastfetch). `Shell`
...
* [dfetch](https://github.com/David17c/Dfetch) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2026-08-13 - A clean and practical system information tool. `Go`
...
* [Haxefetch](https://github.com/ACoolioDude/Haxefetch) ⭐ 0 | 🐛 0 | 🌐 Haxe | 📅 2026-08-13 - Haxefetch is fetch program inspired by neofetch, fastfetch, pfetch, nerdfetch, hyfetch and so on. `Haxe`
* [NerdFetch-C](https://github.com/AnmiTaliDev/NerdFetch-c) ⚠️ Archived - Fetch inspired by nerdfetch, but written in C. `C`
* [slackfetch](https://github.com/r1w1s1/slackfetch) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2026-07-30 - Minimal system information utility for Slackware. `Shell`
...
* [vfetch](https://github.com/carlosqsilva/vfetch) ⭐ 17 | 🐛 1 | 🌐 V | 📅 2026-04-21 - System fetch written in Vlang. `V`
* [mfetch-macos](https://github.com/TechWiz-3/mfetch-macos) ⭐ 9 | 🐛 0 | 🌐 Shell | 📅 2022-07-21 - Minimalist fetch (forked and modified for MacOS). `Shell`

### Other

* [3dfetch](https://github.com/aliceinpalth/3dfetch) ⭐ 42 | 🐛 1 | 🌐 Lua | 📅 2018-05-12 - Displays various information about your Nintendo 3DS in pretty colors. `Lua`
...
* [gpufetch](https://github.com/Dr-Noob/gpufetch) ⭐ 193 | 🐛 34 | 🌐 C++ | 📅 2025-10-26 - Simple yet fancy GPU architecture fetching tool. `C++`
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,020 | 🐛 61 | 🌐 Rust | 📅 2026-08-11 - Git repository summary on your terminal. `Rust`
* [gitfetch](https://github.com/Matars/gitfetch) ⭐ 390 | 🐛 1 | 🌐 Python | 📅 2026-07-05 - A neofetch alternative for GitHub quick view. `Python`
...
* [songfetch](https://github.com/ekrlstd/songfetch) ⭐ 109 | 🐛 8 | 🌐 Python | 📅 2025-11-16 - A Linux CLI tool, very similar to neofetch, that displays current song information in the terminal. `Python`
* [richweather](https://github.com/Rizen54/richweather) ⭐ 45 | 🐛 1 | 🌐 Python | 📅 2024-10-23 - A customizable beautiful and colorful weather fetch utility accessible with pin codes or city names. `Python`
* [kitget](https://github.com/adamperkowski/kitget) ⭐ 33 | 🐛 0 | 🌐 Rust | 📅 2026-01-29 - Display and customize cat images in your terminal. `Rust`
* [xfcfet](https://github.com/xfcisco/xfcfet) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2020-11-05 - My own version of neofetch that includes sys info, spotify info, and ascii picture. `Python`
* [wfetch](https://github.com/igormako/wfetch) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2021-11-23 - A small (\~100 lines of code) terminal weather fetch tool written in Python. `Python`
* [gmod-fetch](https://github.com/garryspins/gmod-fetch) ⭐ 6 | 🐛 1 | 🌐 Lua | 📅 2020-11-21 - GFetch is a neofetch-clone for Garry's Mod. `Lua`
* [fetchfetch](https://github.com/TheBicPen/fetchfetch) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2023-06-18 - A tool to fetch info about the fetches installed on your system. `Rust`
* [webfetch](https://github.com/ensomnatt/webfetch) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2025-06-19 - Webfetch is a program that displays your system information on the web, running as a systemd unit. `Go`
* [mtgfetch](https://github.com/monteluka/mtgfetch) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2024-11-19 - Magic: The Gathering card information fetcher. `C++`
* [pokestats](https://github.com/mdatz/pokestats) ⭐ 2 | 🐛 0 | 🌐 Shell | 📅 2026-04-15 - Terminal fetch tool for viewing pokemon stats and abilities. `Shell`
