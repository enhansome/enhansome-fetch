...
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,676 | 🐛 92 | 🌐 C | 📅 2026-09-18 - Like neofetch, but much faster because written in C. `C`
...
* [macchina](https://github.com/Macchina-CLI/macchina) ⭐ 1,971 | 🐛 12 | 🌐 Rust | 📅 2025-03-08 - A system information fetcher, with an emphasis on performance and minimalism. `Rust`
...
* [animfetch](https://github.com/Andrew-Velox/animfetch) ⭐ 150 | 🐛 2 | 🌐 Rust | 📅 2026-09-17 - Animated system fetch that stays pinned above your shell while you work. `Rust`
...
* [winfetch](https://github.com/lptstr/winfetch) ⭐ 1,786 | 🐛 25 | 🌐 PowerShell | 📅 2024-05-09 - A command-line system information utility written in PowerShell. Like Neofetch, but for Windows. `PowerShell`
...
* [Haxefetch](https://github.com/ACoolioDude/Haxefetch) ⭐ 6 | 🐛 0 | 🌐 Haxe | 📅 2026-09-17 - Haxefetch is fetch program inspired by neofetch, fastfetch, pfetch, nerdfetch, hyfetch and so on. `Haxe`
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,049 | 🐛 66 | 🌐 Rust | 📅 2026-09-18 - Git repository summary on your terminal. `Rust`
